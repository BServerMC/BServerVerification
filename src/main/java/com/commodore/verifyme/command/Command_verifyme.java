            ...
            case 1:
                switch(args[0])
                {
                    ...
                    case "help":
                        ...
                        playerSender.sendMessage(ChatColor.BLUE + "2. Copy the code that command gave you and jump on the forums, from there PM the bot named " + plugin.getConfig().getString("BotName") + " with the token.");
